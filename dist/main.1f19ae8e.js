...
var myMovieKey = 'API 키는 공개할 수 없으므로 삭제함';
function getMovies(keyword) {
  _axios.default.get("".concat(myMovieKey, "&s=").concat(keyword)).then(function (response) {
    var searchResult = response.data.Search[0];
    ...
    moviePoster.alt = "".concat(searchTitle.Title, ", ").concat(searchTitle.Year);
  }).catch(function (error) {
    // console.error(error);
  }).finally(function () {
    console.info("\"".concat(keyword, "\" \uAC80\uC0C9\uC5B4\uB85C \uCC3E\uAE30 \uC644\uB8CC"));
  });
}
getMovies('aliens');
...
var myCycleKey = 'API 키는 공개할 수 없으므로 삭제함';
function getCycleData() {
  return _getCycleData.apply(this, arguments);
}
function _getCycleData() {
  _getCycleData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var from,
      to,
      fetchURL,
      response,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          from = _args.length > 0 && _args[0] !== undefined ? _args[0] : 1;
          to = _args.length > 1 && _args[1] !== undefined ? _args[1] : 5;
          fetchURL = "http://openapi.seoul.go.kr:8088/".concat(myCycleKey, "/json/bikeList/").concat(from, "/").concat(to, "/");
          _context.next = 5;
...
getCycleData(1, 10);
},{"lodash":"node_modules/lodash/lodash.js","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
